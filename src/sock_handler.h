#ifndef SRC_SOCK_HANDLER_H
#define SRC_SOCK_HANDLER_H
...
struct SocketOptions {
  ...
  std::unique_ptr<SockHandler> conn;
...
class SockHandler {
 public:
  ...
  SockHandler(Epoll& epl, int sock, const struct sockaddr_in& addr)
      : epl_(epl),
 ...
 private:
  ...
  BAN_COPY_AND_ASSIGN(SockHandler);
};

#endif  // SRC_SOCK_HANDLER_H
